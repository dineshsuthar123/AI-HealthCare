                            ...
                            >
                                ...
                                >
                                    ...
                                    <div className="p-6">
                                        {isLoadingRecords ? (
                                            ...
                                            <div className="text-center py-8">
                                                <DnaAnimation width={60} height={60} className="mx-auto mb-4" />
                                                <h3 className="text-xl font-semibold mb-2 gradient-text bg-gradient-to-r from-blue-600 to-indigo-600">{tHealth('noRecords')}</h3>
                                    ...
                                    <div className="border-t border-gray-200 dark:border-gray-700/50 p-4 flex justify-between">
                                        <Link href="/health-records">
                                            <Button variant="glassDark" animated>
